...
class SandwichesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sandwich" do
    assert_difference('Sandwich.count') do
      post sandwiches_url, params: { sandwich: { bread_type: @sandwich.bread_type, price: @sandwich.price, sauce: @sandwich.sauce } }
    end
  ...
  test "should update sandwich" do
    patch sandwich_url(@sandwich), params: { sandwich: { bread_type: @sandwich.bread_type, price: @sandwich.price, sauce: @sandwich.sauce } }
